//
//  UIImage+Blured_And_SnapShot_Image.m
//  ALCOMATH
//
...
#import "UIImage+Blured_And_SnapShot_Image.h"
#import "UIImage+ImageEffects.h"
@import Accelerate;
#import <float.h>

@implementation UIImage (Blured_And_SnapShot_Image)

+ (UIImage *)blurWithGPUImage:(UIImage *)sourceImage Radius: (int) radius Color: (UIColor *) tintColor
{
    return [sourceImage applyBlurWithRadius:radius tintColor:tintColor saturationDeltaFactor:1.5 maskImage:nil];
}
...
+ (UIImage *)blurBackgroundView:(UIView *)backgroundView Radius: (int) radius
{
    ...
    [backgroundView drawViewHierarchyInRect:CGRectMake(0, 0, backgroundView.frame.size.width/reductionFactor, backgroundView.frame.size.height/reductionFactor) afterScreenUpdates:NO];
    UIImage *image = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
